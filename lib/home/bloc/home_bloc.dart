...
import 'package:plateron_assignment/home/network/home_api_provider.dart';
...
class HomeScreenBloc {
  ...
  LinkedHashMap<String, ProductList>? map = new LinkedHashMap();
  List<ProductList> cartList = [];

  BehaviorSubject<List<ProductList>> _cartListController =
  ...
  BehaviorSubject<List<ProductList>> _productListController =
      BehaviorSubject<List<ProductList>>.seeded([]);

  BehaviorSubject<List<ProductList>> get productConListtroller =>
      _productListController;

  BehaviorSubject<int> _badgeController = BehaviorSubject<int>.seeded(0);
